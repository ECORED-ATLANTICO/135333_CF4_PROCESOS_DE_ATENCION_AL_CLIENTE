  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.justify-content-center
      .col-lg-12.mb-5.bgs.p-4.brad
        figure
          img(src="@/assets/curso/sintesis.svg", alt="En la síntesis de este componente se detalla la gestión de requerimientos e indicadores de gestión como son: - Normativa y requerimientos en atención al cliente. - Sistema de calidad. - Indicadores de gestión.")
      .col-auto
